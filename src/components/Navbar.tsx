      ...
      <div className="bg-[#f2f2f2] border-b border-gray-200">
        <div className="max-w-screen-2xl mx-auto px-4 sm:px-8 h-10 flex justify-between items-center text-[10px] sm:text-xs">
          <div className="flex items-center gap-6 divide-x divide-gray-300">
            ...
            <div className="hidden sm:flex items-center gap-4 pl-6 border-l border-gray-300">
              {user ? (
        ...
        <div className="max-w-screen-2xl mx-auto px-4 sm:px-8 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4 w-1/4">
            <Link to="/" className="flex items-center gap-4 group">
              <img 
                ...
                alt="Talibon Seal" 
                className="w-16 h-16 sm:w-20 sm:h-20 object-contain drop-shadow-md transition-transform group-hover:rotate-6" 
          ...
          <div className="flex items-center gap-4 w-1/4 justify-end">
            <button 
              ...
              className="p-3 hover:bg-gray-100 rounded-full text-brand-primary transition-all hover:scale-110 active:scale-95 border border-brand-primary/10"
            >
