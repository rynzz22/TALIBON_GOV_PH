      ...
      <nav className={`transition-all duration-500 ${isScrolled ? 'bg-white/95 shadow-lg shadow-blue-900/5 py-2' : 'bg-white py-4'} border-b border-blue-50 backdrop-blur-xl`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            >
              <div className="w-14 h-14 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl p-0.5 shadow-lg shadow-blue-500/20 group-hover:scale-105 transition-transform">
                <div className="w-full h-full bg-white rounded-[14px] p-1 flex items-center justify-center">
                  <div className="w-full h-full bg-gray-50 rounded-xl border border-dashed border-gray-200 flex items-center justify-center text-[8px] font-black text-gray-300">SEAL</div>
                </div>
              </div>
              ...
              <div className="flex justify-between items-center p-6 border-b border-blue-800">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-white rounded-full p-1 flex items-center justify-center">
                    <div className="w-full h-full bg-gray-50 rounded-full border border-dashed border-gray-200 flex items-center justify-center text-[8px] font-black text-gray-300">SEAL</div>
                  </div>
