        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {events.map((event, index) => (
            <motion.div
              ...
              className="group bg-white rounded-[40px] overflow-hidden border border-gray-100 hover:border-blue-200 hover:shadow-2xl hover:shadow-blue-500/5 transition-all"
            >
              ...
              <div className="p-8 space-y-6">
                ...
                <button className="w-full py-4 rounded-2xl bg-gray-50 text-gray-900 font-bold flex items-center justify-center gap-2 group-hover:bg-blue-600 group-hover:text-white transition-all">
